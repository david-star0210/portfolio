  ...
  const experiences = [
    {
      ...
      icon: Cloud,
      achievements: [
        'Spearheaded end-to-end web development, optimizing performance across frontend and backend in a remote environment.',
        'Built reusable React components, accelerating feature development and easing maintenance.',
        'Implemented Redux for scalable state management and designed RESTful APIs with Express and .NET.',
        'Leveraged Entity Framework for efficient database handling.',
        'Led CI/CD with GitHub and Azure DevOps for smooth, automated deployments.'
      ]
    },
    {
      ...
      achievements: [
        ...
        'Resolved 100+ critical bugs, delivering scalable, stable, and seamless user experiences that exceeded client expectations.'
      ]
    }
  ]
