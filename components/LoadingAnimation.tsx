    ...
    >
      <div className="text-center">
        ...
        <div className="relative mb-8">
          <motion.div
            className="w-20 h-20 mx-auto rounded-full bg-gradient-to-r from-blue-500 to-purple-500 opacity-20"
          ...
          />
          <motion.div
            className="absolute inset-0 w-16 h-16 mx-auto mt-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 opacity-30"
            variants={circleVariants}
            animate={{
              scale: [1, 0.8, 1],
              rotate: [360, 0]
